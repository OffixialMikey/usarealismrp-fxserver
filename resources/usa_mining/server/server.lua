...
local common = {
    {name = "Aluminum", type = "misc", price = 150, legality = "legal", quantity = 1, weight = 5.0},
    {name = "Copper", type = "misc", price = 10, legality = "legal", quantity = 1, weight = 10.0},
    {name = "Iron", type = "misc", price = 175, legality = "legal", quantity = 1, weight = 15.0}
}
